    ...
    const socials = [
        {
            ...
            link: 'https://github.com/lethargistic/ohthatsuseful',
        },
        {
            text: 'Bluesky',
...
<footer>
    ...
    <div class="luv-seg">
        <p>Made by Leth with ❤️ & ☕<br> Hope you bookmarked a thing or two!</p>
        <a class="sauce" href="https://github.com/lethargistic/ohthatsuseful">This site is open source!
